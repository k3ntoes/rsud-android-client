...
| `sort_order` | int | Urutan tampilan item dalam checklist inspeksi ruangan — urutkan ascending; tie-breaker: `item_id` ASC. Diatur Admin PPI per ruangan via web-admin (ADR-0013 BE / ADR-0019 Android) |
...
`sort_order ASC, item_id ASC`. Detail: `docs/BE/docs/adr/0013-room-item-ordering.md`
dan keputusan Android `docs/adr/0019-room-item-ordering-android.md`.
